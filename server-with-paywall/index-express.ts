...
const paywall = createPaywall()
  .withNetwork(avmPaywall)          // Algorand network support
  .withConfig({
    appName: 'weather_api',         // App name, appearing in paywall UI
    testnet: true,                  // Use testnet
    // appLogo: '/logo.png',        // Optional: logo appearing in paywall UI
  })
  .build();
...
app.use(
  paymentMiddleware(
    ...
    paywall, // Pass the paywall instance to the middleware
  ),
);
